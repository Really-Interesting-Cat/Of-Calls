...
public class GuiApp extends Application {
  ...
  class MyBrowser extends Region{
      ...
      public MyBrowser(){
          webEngine.load("https://really-interesting-cat.github.io/webview/");
         
          Button buttonClear = new Button("test");
          buttonClear.setOnAction(new EventHandler<ActionEvent>() {

        	  public void handle(ActionEvent arg0) {
        		  webEngine.executeScript("accident(37.241366, 131.865270)");
        	  }
          });
          ...
          toolbar.getChildren().addAll(buttonClear);
